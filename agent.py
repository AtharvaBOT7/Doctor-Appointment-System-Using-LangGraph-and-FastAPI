...
class DoctorAppointmentAgent:
    ...
    def supervisor_node(self, state: AgentState) -> Command[Literal['information_node', 'booking_node','__end__']]:
        ...
        print("******************************Below is my updated state******************************")
        print(state)
    ...
    def information_node(self, state: AgentState) -> Command[Literal['supervisor']]:
        ...
        system_prompt = "You are a specialized agent to provide information related to availability of doctors or any FAQs related to hospital based on the query. You have access to to the tool. \n Make sure to ask the user politely if you need any further information to execute the tool. For your information, always consider current year as 2024."
    ...
    def booking_node(self, state: AgentState) -> Command[Literal['supervisor']]:
        ...
        system_prompt = "You are specialized agent to set, cancel or reschedule appointments based on the query. You have access to the tool. \n Make sure to ask user politely if you need any further informationto execute the tool. \n For your information, always consider the year to be 2024."
